...
const ProjectDetails = () => {
  ...
  return (
    <>
      <SEO
        title="Project Details - Muhammad Yusuf Saputra"
        description={project?.description}
        author="Muhammad Yusuf Saputra"
        keywords={`${project?.title}, Muhammad Yusuf Saputra, Project Muhammad Yusuf Saputra, Portfolio, Frontend Developer, Frontend Developer Portfolio, FullStack Web Developer, Project - Muhammad Yusuf Saputra`}
        robots="index, follow"
        ...
        TwTitle={`Project ${project?.title} - Muhammad Yusuf Saputra`}
